...
public class DoubleScaleLPos1 extends CommandGroup {
    ...
    public DoubleScaleLPos1() {
    	...
    	addSequential(new EncGyroPlease(5500,5500,1.0,true));//Forward towards switch
    	...
    	addSequential(new EncGyroPlease(400,400,1,false));
    	addSequential(new AutonWait(0.5));
    	addSequential(new EncGyroPlease(400,400,0.5,true));
    	
    	/*Auton for inwards scale placement unused for testing other auton
    	addSequential(new EncGyroPlease(800,800,1.0,true));//Travel inwards 
    	addSequential(new AutonWait(0.25));//Delay
    	addSequential(new AutonTurn(90, true));//Turn left towards the scale
    	addSequential(new EncGyroPlease(600,600,1.0,true));//Travel towards the scale
    	...
    	addSequential(new EncGyroPlease(600,600,1.0,true));//Go towards the prism
