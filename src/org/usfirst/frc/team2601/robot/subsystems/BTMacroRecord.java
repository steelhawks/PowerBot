...
public class BTMacroRecord {
	...
	public void record() throws IOException
	{
		...
		//drive motors
		writer.append("," + Robot.drivetrain.leftGroup.get());
		writer.append("," + Robot.drivetrain.rightGroup.get());
		
		//barrel motors
		/*writer.append("," + Robot.drivetrain);
		...
		*/
		...
		writer.append("," + Robot.drivetrain.shiftSol.get() + "\n");
